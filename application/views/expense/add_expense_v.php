...
<form method="POST" class="form-horizontal form1" action="<?php echo base_url().'index.php/expense/expense/add_expense' ; ?>" >
<fieldset>
<legend>Add Expense</legend>
<div class="form-group">
  <label class="control-label" for="expensedate">Date</label>  
  <input id="expensedate" name="expensedate" type="date" placeholder="Expense Date" class="form-control">
  <?php echo form_error('expensedate'); ?>
  </div>
  <div class="form-group">
  <label class="control-label" for="expensedescription">Description</label>  
  <input id="expensedescription" name="expensedescription" type="text" placeholder="Description" class="form-control">
    <?php echo form_error('expensedescription'); ?>
  </div>
<div class="form-group">
  <label class="control-label" for="expenseamount">Amount</label>  
  <input id="expenseamount" name="expenseamount" type="number" placeholder="Amount" class="form-control">
