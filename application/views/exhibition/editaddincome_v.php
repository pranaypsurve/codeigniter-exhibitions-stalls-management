...
<form method="POST" class="form-horizontal" action="<?php echo base_url().'index.php/exhibition/exhibition/editaddIncome/'.$exhibition_Id.'/'.$stand_id.'/'.$getincomedata['income_id'] ; ?>" >
<fieldset>
<legend>Add Income</legend>
<div class="form-group">
  <label class="control-label" for="fname">Date</label>  
  <input id="fname" name="incomeDate" type="date" placeholder="Stand No" value="<?php echo $getincomedata['date']; ?>" class="form-control">
  <?php echo form_error('incomeDate'); ?>
</div>
<div class="form-group">
  <label class="control-label" for="total_earning">Income</label>  
  <input id="total_earning" name="income" type="number" placeholder="Income" value="<?php echo $getincomedata['income']; ?>"  class="form-control">
