...
<form method="POST" class="form-horizontal form1" action="<?php echo base_url().'index.php/income/income/edit_add_income/'.$get_income->income_id ; ?>" >
<fieldset>
<legend>Edit Income</legend>
<div class="form-group">
  <label class="control-label" for="incomedate">Date</label>  
  <input id="incomedate" name="incomedate" type="date" placeholder="Start Date" value="<?php echo $get_income->date; ?>" class="form-control">
  <?php echo form_error('incomedate'); ?>
  </div>
  <div class="form-group">
  <label class="control-label" for="incomedescription">Description</label>  
  <input id="expensedescription" name="incomedescription" type="text" placeholder="Description" value="<?php echo $get_income->description; ?>" class="form-control">
    <?php echo form_error('incomedescription'); ?>
  </div>
<div class="form-group">
  <label class="control-label" for="incomeamount">Amount</label>  
  <input id="incomeamount" name="incomeamount" type="number" placeholder="Amount" value="<?php echo $get_income->amount; ?>" class="form-control">
